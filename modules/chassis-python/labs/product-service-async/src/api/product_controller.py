...
async def get_repo(session: AsyncSession = Depends(get_session)) -> ProductRepository:
    return ProductRepository(session)

async def get_service(repo: ProductRepository = Depends(get_repo)) -> ProductService:
